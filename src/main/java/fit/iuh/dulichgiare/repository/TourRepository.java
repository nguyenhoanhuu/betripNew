...
public interface TourRepository extends JpaRepository<Tour, Long> {
	...
	@Query(value = "SELECT t.* FROM tour t WHERE t.active = true GROUP BY t.destination, t.id, t.active,t.image,t.departure,t.destination,t.departureTime,t.startDay,t.endDay,t.numberOfDay,t.numberOfPeople,t.subcriber,t.type,t.price,t.createAt,t.liked,t.createdBy,t.policy_id,t.promotion_id ORDER BY SUM(t.liked) DESC", nativeQuery = true)
