...
public class Constants {
	...
	public final static String BOOKING_STRIPE_PAYMENT_TEMPLATE = "stripe_payment_template.html";
	public final static String BOOKING_CASH_PAYMENT_TEMPLATE = "cash_payment_template.html";
	public final static String BOOKING_TRANSFER_PAYMENT_TEMPLATE = "transfer_payment_template.html";
	...
	public final static String NOTIFICATION_CONFIRM_PAYMENT_METHOD = "Thông báo: Xác nhận hình thức thanh toán đơn đặt tour TripHappy";
	public final static String URL_SHOW_BOOKING_DETAIL = "https://triphappy.vercel.app/detailBooking/{0}";
